    ...
    <div class="p-6">
      ...
      <div class="text-center mb-6">
        <div class="relative inline-block">
          <div class="w-24 h-24 rounded-full overflow-hidden mx-auto mb-3 border-4 border-orange-200">
            <img 
              :src="localProfile.avatar_url || '@/img/CapyBuddy Assets/Profile/Avatar_Student/bear.png'"
              alt="Profile"
              class="w-full h-full object-cover"
            />
          </div>
          <button 
            @click="playClick('student'); openAvatarModal()"
      ...
      <div class="space-y-6">
        ...
        <div class="border-t pt-6">
          ...
          <div class="flex items-center justify-between py-3">
            ...
            <ion-toggle 
              v-model="localProfile.sound_enabled"
              color="warning"
            ></ion-toggle>
          </div>
          ...
          <div class="flex items-center justify-between py-3">
            ...
            <ion-toggle 
              v-model="localProfile.dark_mode"
              color="warning"
            ></ion-toggle>
          </div>
        </div>
        ...
        <div class="space-y-3 pt-6">
          <ion-button
            @click="playClick('student'); saveProfile()"
            expand="block"
            class="save-button"
            :disabled="isSaving"
          >
          ...
          <ion-button
            @click="playClick('student'); changePassword()"
            expand="block"
            fill="outline"
          ...
          <ion-button
            @click="playClick('student'); signOut()"
            expand="block"
            fill="clear"
...
// Cleanup on unmount
onBeforeUnmount(() => {
  console.log("🔇 ProfileModal unmounting - stopping music...");
  stopMusic();
});
</script>
