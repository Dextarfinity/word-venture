  ...
  <div class="h-full bg-white">
    ...
    <div class="bg-gradient-to-r from-purple-400 to-pink-400 px-6 py-4">
      <div class="flex items-center justify-between">
        ...
        <button 
          @click="playClick('student'); $emit('close')"
    ...
    <div class="p-6">
      ...
      <div class="text-center mb-6">
        <div class="w-32 h-32 rounded-full overflow-hidden mx-auto mb-4 border-4 border-purple-200 shadow-lg">
          <img 
        ...
        <p class="text-gray-600">{{ selectedAvatar ? 'New Avatar Selected' : 'Current Avatar' }}</p>
      </div>
      ...
      <div class="mb-6">
        ...
        <div class="flex space-x-2 overflow-x-auto pb-2">
          <button
            ...
            :key="category.id"
            @click="playClick('student'); selectedCategory = category.id"
            :class="[
      ...
      <div class="mb-6">
        <h4 class="text-md font-semibold text-gray-800 mb-3">
          {{ avatarCategories.find(c => c.id === selectedCategory)?.name || 'Animals' }}
        </h4>
        <div class="grid grid-cols-4 gap-4">
          <div
            v-for="avatar in currentCategoryAvatars"
            :key="avatar.id"
            @click="playClick('student'); selectAvatar(avatar.url)"
            :class="[
      ...
      <div class="mb-6 p-4 bg-gray-50 rounded-2xl">
        ...
        <div class="flex items-center space-x-4">
          ...
          >
          <button
            @click="playClick('student'); $refs.fileInput.click()"
          ...
          >
            <ion-icon :icon="cloudUploadOutline" class="text-2xl text-gray-400 mb-2"></ion-icon>
      ...
      <div class="flex space-x-3">
        ...
        <ion-button
          @click="playClick('student'); confirmSelection()"
          expand="block"
...
const { currentAvatar: savedAvatar, setAvatar, getAvatar } = useAvatar();
const { startMusic, stopMusic, playClick } = useAudio();

// Local state
const selectedCategory = ref('animals');
const selectedAvatar = ref("");
const defaultAvatar = '@/img/CapyBuddy Assets/Profile/Avatar_Student/bear.png';

// Initialize with saved avatar on mount
onMounted(() => {
  console.log("🎵 Starting menu music for AvatarSelectionModal...");
  startMusic(MUSIC_TYPES.MENU, 0.3);
  
  const stored = getAvatar();
  selectedAvatar.value = stored;
  console.log('🎨 Loaded avatar from storage:', stored);
});

onBeforeUnmount(() => {
  console.log("🔇 Stopping menu music for AvatarSelectionModal...");
  stopMusic();
});
  ...
  animals: [
    {
      id: 'bear',
      name: 'Bear',
      url: '@/img/CapyBuddy Assets/Profile/Avatar_Student/bear.png'
    },
    {
      id: 'cat',
      name: 'Cat',
      url: '@/img/CapyBuddy Assets/Profile/Avatar_Student/cat.png'
    },
    {
      id: 'chicken',
      name: 'Chicken',
      url: '@/img/CapyBuddy Assets/Profile/Avatar_Student/chicken.png'
    },
    {
      id: 'rabbit',
      name: 'Rabbit',
      url: '@/img/CapyBuddy Assets/Profile/Avatar_Student/rabbit.png'
    },
  ],
  capybaras: [
    {
